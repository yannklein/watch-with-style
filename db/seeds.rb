...
hero = List.create(name: "Super Hero 🦸")
List.create(name: "Drama 😿")
List.create(name: "Drama 😿")


10.times do
  List.create(name: Faker::Coffee.blend_name)
end

Bookmark.create(list: hero, movie: wonder, comment: "Love Wonder Woman <3")
Bookmark.create(list: hero, movie: ocean, comment: "Normal life heroes!")